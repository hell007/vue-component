<template>
  <div class="friendSearchContainer">
    <div v-if="multiple===true" contenteditable="true" class="smartInput-input smartInput" :placeholder="placeholder" @click="initBadgeInput">
      <ul class="smartInput-badge-list">
        ...
        <li class="smartInput-badge">
          <input v-model="searchString" @keyup="keyboardDown" class="smartInput-search" v-focus ref="autoFocus" @blur="blur" />
        </li>
      </ul>
    </div>
    <input v-else v-model="searchString" class="smartInput-input smartInput" :placeholder="placeholder" @click="init" @keyup="keyboardDown" @blur="blur" />
    ...
    <ul v-show="searching" class="friendSearchList">
      ...
      <li v-else v-for="(item, index) in filtered" :class="{'smartInput-active': selected.includes(item)}" @click.stop="clickOne" @mouseover="hoverOn">{{ item }}
      </li>
    </ul>
